/**
 * @file bench_bignum_is_prime_mt.c
 * @brief ISO C entry point for the multi-thread bignum_is_prime benchmark.
 *
 * @details
...
#include "adapter/bignum_is_prime_benchmark_adapter.h"
...
int main(int argc, char **argv)
{
    ...
    bignum_is_prime_benchmark_status_t adapter_status;
    benchmark_core_status_t core_status;

    adapter_status = bignum_is_prime_benchmark_adapter_init(&adapter);
    if (adapter_status != BIGNUM_IS_PRIME_BENCHMARK_STATUS_SUCCESS) {
        return EXIT_FAILURE;
    }
